const workExperienceInfo = [
  {
    id: 1,
    companyName: "Sanmina-SCI Systems Pte Ltd, Singapore",
    jobTitle: "Process Engineer",
    logoReference: "sanminaLogo.png",
    duration: "November'2020 - Present",
    technicalSkills: [
      "Trained Green Belt Six Sigma",
      "Microsoft Office: Powerpoint, Excel, Word",
    ],
    jobResponsibilities: [
      "In-charged of electroless/eletrolytic nickel gold plating lines, a type of surface finishing for printed circuit boards.",
      "Identify, investigate and troubleshoot the production defect, continuously improve the process and ensure the outcomes meeting the production yield target.",
      "Ensure the process documents are complied by the in-charged production employees, revise documents if new guidelines are established.",
    ],
  },
  {
    id: 2,
    ...
    logoReference: "keysightLogo.png",
  ...
  {
    id: 3,
    companyName: "Plexus Manufacturing Sdn Bhd, Penang, Malaysia",
    jobTitle: "Quality Assurance Trainee",
    logoReference: "plexusLogo.png",
    duration: "November'2016 - February'2017",
    technicalSkills: [
      "Microsoft Office: Powerpoint, Excel, Word",
      "Quality Analysis Tools: Histogram, Pareto Chart",
    ],
    jobResponsibilities: [
      "Identify cosmetic defects (dents, pits, or scratches) on hardware part using specific defect measurement tool.",
      "Draft Standard Operating Procedures in English and Malay for new products transferred.",
      "Establish better data filtering and analysis approach using VBA in Microsoft Excel",
    ],
  },
];
